    ...
    <>
      <div class="bg-custom-white p-4">
        ...
        <div class="bg-custom-dark-gray flex flex-col items-center space-y-4 p-6 rounded-2xl mt-6">
          ...
          Put that marketing budget to good use! Get your Token in front of <span class="font-inter font-bold text-[24px] leading-[27px] text-center">30Million+</span> Web3 People <br />
            through Placing your Ads on <span class="font-inter font-bold text-[24px] leading-[27px] text-center">12,000+ </span>Websites and Apps
          </p>
          ...
          {/* <!-- Button --> */} 
          <button class="bg-custom-red text-white font-bold py-2 px-4 
          ...
          ">
          <Link to="/token">  Order Now - 399$/<br />
            Lifetime
            </Link>
          </button>
        </div>
